(function () {
    ...
    function AuthenticationService($http, $cookieStore, $rootScope, $timeout, UserService) {
        ...
        service.IsUserCustomer = IsUserCustomer;
        service.IsUserLibrarian = IsUserLibrarian;
        ...
        function Login(user) {
            ...
            return $http.post('/library/rest/users/auth', user)
        ...
        function SetCredentials(password, user) {
        ...
        function IsUserCustomer(){
        	...
        	return $rootScope.globals.currentUser.user.roles.includes('CUSTOMER');
        }
        ...
        function IsUserLibrarian(){
        	...
        	return $rootScope.globals.currentUser.user.roles.includes('LIBRARIAN');
        }
        ...
        function IsUserAdmin(){
        	...
        	return $rootScope.globals.currentUser.user.roles.includes('ADMIN');
        }
